...
ego_fields <- function(network_wide) {
  list(
    ...
    ego_age_in_months = suppressWarnings(as.numeric(pull_safe(network_wide, "child_age_in_months", type="double"))),
...
# We store validity per ChildID in demo_flags, and join into network_wide.
# =============================================================================
